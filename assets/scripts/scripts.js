...
typewriter.typeString('Hey!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("I'm studying Management Information Systems & Computer Science")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("I love to be creative!")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("I love furbabies!")
    .pauseFor(1000)
    .deleteAll()
